...
模块的注意事项：Spring框架的jar包允许部署在JDK9的模块路径（“Jigsaw”）。为了在支持Jigsaw的应用中使用，Spring Framework5的jar包来自“自动化模块名”清单条目中定义的稳定语言级模块名称（“spring.core”，“spring.context”等）独立于jar构件名（jars遵循相同的格式“-”而不是“.”，例如“spring-core”,‘“spring-context”）。当然Spring farmework的jar包在JDK8和9的classpath下都能正常运行。
